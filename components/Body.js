...
function Body({chooseTrack,spotifyApi}) {
    const accessToken = "BQAfexTpEq5F0UWG1Oc7Kj1Ku2o9UiKeYY1qmcvQwhvTUuxMG8PPqFjXuIB7TUsYwbUAq_K6CtRVed73XbYFwYeROt6gl0RPu8o8sPnlw4OMCR9qAXQ_v_NZvucBU3u9fuaSibOGKVstd4rckfLqGVlnYAC3wrKdpxpoU70H3mv9Kg6pinY";
    ...
    return (
       <section className="bg-black ml-24 py-10 space-y-8 md:max-w-6xl flex-grow md:mr-2.5"> 
